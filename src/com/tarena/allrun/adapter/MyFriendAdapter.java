...
public class MyFriendAdapter extends BaseExpandableListAdapter {
	...
	public Object getChild(int groupPosition, int childPosition) {
		RosterGroup rosterGroup = listGroup.get(groupPosition);
		ArrayList<RosterEntry> listFriend = new ArrayList<RosterEntry>(rosterGroup.getEntries());
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		try {
			...
			if (convertView == null) {
				convertView = View.inflate(context, R.layout.myfriend_group, null);
				viewHodlerGroup = new ViewHodlerGroup();
				viewHodlerGroup.tvGroupName = (TextView) convertView.findViewById(R.id.tv_my_friend_groupName);
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
		...
		try {
			...
			if (convertView == null) {
				convertView = View.inflate(context, R.layout.myfriend_friend, null);
				viewHodlerFriend = new ViewHodlerFriend();
				viewHodlerFriend.tvFriendName = (TextView) convertView.findViewById(R.id.tv_my_friend_friendName);

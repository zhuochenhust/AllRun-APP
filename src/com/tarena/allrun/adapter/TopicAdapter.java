...
public class TopicAdapter extends BaseAdapter {
	...
	public TopicAdapter(Context context, ArrayList<TopicEntity> list, BitmapUtils bitmapUtils) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.tvUsername = (TextView) convertView.findViewById(R.id.tv_topic_item_username);
			viewHolder.tvBody = (TextView) convertView.findViewById(R.id.tv_topic_item_body);
			viewHolder.tvAddress = (TextView) convertView.findViewById(R.id.tv_topic_item_address);

			viewHolder.ivImage = (ImageView) convertView.findViewById(R.id.iv_topic_item_image);

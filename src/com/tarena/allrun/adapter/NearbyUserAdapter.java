...
public class NearbyUserAdapter extends BaseAdapter {
	...
	public NearbyUserAdapter(Context context, ArrayList<UserEntity> list, BitmapUtils bitmapUtils) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		try {
			...
			if (convertView == null) {
				convertView = View.inflate(context, R.layout.nearby_user_item, null);
				viewHolder = new ViewHolder();
				viewHolder.ivUserIcon = (ImageView) convertView.findViewById(R.id.iv_nearby_use_item_userIcon);
				viewHolder.tvName = (TextView) convertView.findViewById(R.id.tv_nearby_user_item_name);
			...
			String imageUrl = "http://" + TApplication.host + ":8080" + userEntity.getIconUrl();

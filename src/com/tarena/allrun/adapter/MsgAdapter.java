...
public class MsgAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.ll_unAccept = (LinearLayout) convertView.findViewById(R.id.ll_unAccept);
			viewHolder.ll_accept = (LinearLayout) convertView.findViewById(R.id.ll_accept);
			viewHolder.tv_unAccept = (TextView) convertView.findViewById(R.id.tv_unAccept);
			viewHolder.tv_accept = (TextView) convertView.findViewById(R.id.tv_accept);
			viewHolder.btnChat = (Button) convertView.findViewById(R.id.btn_chat);

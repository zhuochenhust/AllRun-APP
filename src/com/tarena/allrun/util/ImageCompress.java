...
public class ImageCompress {
	...
	public Bitmap compressFromUri(Context context, CompressOptions compressOptions) {
		...
		int desiredWidth = getResizedDimension(compressOptions.maxWidth, compressOptions.maxHeight, actualWidth,
				actualHeight);
		int desiredHeight = getResizedDimension(compressOptions.maxHeight, compressOptions.maxWidth, actualHeight,
				actualWidth);
	...
	// ImageCompress.CompressOptions options = new

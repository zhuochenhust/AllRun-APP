...
public class TopicBiz {
	public static void queryAddress(String latitude, String longitude) {
		...
		httpUtils.send(HttpMethod.GET, Const.MAP_QUERY_ADDRESS, requestParams, new RequestCallBack<String>() {
	...
	public static void createTopic(final UserEntity userEntity, String content, byte[] imageData, String address,
	...
	public static void getAllData(final UserEntity entity) {
		String url = "http://" + TApplication.host + ":8080/allRunServer/queryTopic.jsp";
		HttpUtils httpUtils = new HttpUtils(60000);
		RequestParams requestParams = new RequestParams();
		requestParams.addQueryStringParameter("username", entity.getUsername());
		requestParams.addQueryStringParameter("md5password", MD5Util.getStringMD5(entity.getPassword()));

		httpUtils.send(HttpMethod.GET, url, requestParams, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				try {
					...
					list = mapParser.parserAllData(responseInfo.result);

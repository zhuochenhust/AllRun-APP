...
public class UpdateBiz {
	 ...
	 * 
	 * @param apkUrl
	 *            "http://192.168.0.101:8080/allRunServer/allRunSample.apk"
	 */
	...
	public static void getNewVersionInfo(final Handler handler, final String username) {
		String url = "http://" + TApplication.host + ":8080/allRunServer/apkUpdate.jsp?username=" + username;
